...
extension LoginVC {
     ...
     func greetingsLabel() {
        ...
        greatingsLabel.heightAnchor.constraint(equalToConstant: 269).isActive = true
    ...
    private func registrationButtonPlace() {
        ...
        registrationButton.addTarget(self, action: Selector(("registrationButtonTouched:")), for: UIControl.Event.touchUpInside)
    ...
    private func infoLabelPlace(){
        ...
        infoLabel.attributedText = NSMutableAttributedString(string: "Используя данное приложение, я даю своё согласие на обработку моих персональных данных.",
